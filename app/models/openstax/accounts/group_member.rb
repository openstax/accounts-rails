module OpenStax::Accounts
  class GroupMember < ActiveRecord::Base
    ...
    belongs_to :group, class_name: 'OpenStax::Accounts::Group', inverse_of: :group_members
    belongs_to :user, class_name: 'OpenStax::Accounts::Account', inverse_of: :group_members
